...
export default function Day(props) {
  ...
  if (
    ...
    if (dateOutOfRange) {
      // selected start or end date, but not selectable now
      return (
        <View
          style={[
            styles.dayWrapper,
    ...
    // dateOutOfRange = true but not selected start or end date
    return (
      <View style={[styles.dayWrapper, allDayWrapperStyle]}>
        <Text
          style={[
            textStyle,
            allDayTextStyle,
